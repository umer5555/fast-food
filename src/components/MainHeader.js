    ...
    <>
      <div className="mainHeaderSlide">
        ...
        <div className="mainHeaders">
          <div className="  p-4  foodHeader ">
            <nav class=" border-gray-200 dark:bg-gray-900">
              <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div class="text-center">
                  <button
                    class="text-white   focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                    type="button"
                    data-drawer-target="drawer-navigation"
                    data-drawer-show="drawer-navigation"
                    aria-controls="drawer-navigation"
                  >
                    <img src={`${process.env.PUBLIC_URL}/images/menuBar.png`} />
                  </button>
                </div>
        ...
        <div className="hero">
          <div class="container mx-auto  ">
            <div className="grid xl:grid-cols-12 lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12  ">
              ...
              <div className="formBook xl:col-span-6 lg:col-span-6 md:col-span-6   sm:col-span-12    ">
                <div className="bookingBox">
                  <div className="bookingCont">
                    <img
                      src={`${process.env.PUBLIC_URL}/images/bookicon.png`}
                    />
                    <div>
                      <h6>Book a Table</h6>
